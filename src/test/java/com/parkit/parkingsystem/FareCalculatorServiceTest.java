...
public class FareCalculatorServiceTest {
    ...
    @Test
    public void FreeFareCarWithLessThen30MinutesParkingTime() {
        Date inTime = new Date();
        inTime.setTime(System.currentTimeMillis() - (30 * 60 * 1000));// Less than 30 minutes parking time should give
        // 0 parking fare
